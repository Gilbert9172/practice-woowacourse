...
public class ErrorMessage {
    public static String INVALID_PRICE = "[ERROR] 올바른 금액을 입력해야 합니다.";
    public static String INVALID_NUMBER = "[ERROR] 로또 번호는 1부터 45 사이의 숫자여야 합니다.";
    public static String PURCHASE_LIMIT_COUNT = "[ERROR] 1개 이상 구매해야합니다.";
